...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah File Download</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.downloads.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-4 mb-2">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="source_link">Link Eksternal (Google Drive, Dropbox, dll)</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3" id="upload_section">
                        ...
                        <div class="form-text">Maksimal ukuran file: 50MB. Format bebas (PDF, DOCX, ZIP, dll).</div>
                        @error('file_path')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3" id="link_section" style="display: none;">
                        ...
                        <input type="url" class="form-control @error('external_url') is-invalid @enderror" id="external_url" name="external_url" value="{{ old('external_url') }}" placeholder="https://drive.google.com/...">
