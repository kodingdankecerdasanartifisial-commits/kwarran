...
@section('page_title', 'Edit ' . ($isMateri ? 'Materi' : 'Berita'))
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <label for="title" class="form-label fw-bold">Judul {{ $isMateri ? 'Materi' : 'Berita' }}</label>
...
@endphp
                    ...
                    <div class="mb-3">
                        ...
                        @if($post->featured_image)
                            <div class="mb-2">
                                <img src="{{ $post->thumbnail_url }}" alt="Preview" class="img-thumbnail" style="max-height: 150px;">
                        ...
                        <small class="text-muted">Pilih jika ingin mengganti gambar. Format: JPG, PNG, WEBP. Maks: 2MB.</small>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="embed_code" name="embed_code" rows="3" placeholder="Paste embed code (iframe, etc.) here">{{ old('embed_code', $post->embed_code) }}</textarea>
                    ...
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" id="is_html" name="is_html" value="1" {{ old('is_html', $post->is_html) ? 'checked' : '' }}>
