        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="role" class="form-select @error('role') is-invalid @enderror" id="roleSelect" required>
                    <option value="admin"          {{ old('role') == 'admin' ? 'selected' : '' }}>Admin (Semua Akses)</option>
                    <option value="humas"          {{ old('role') == 'humas' || !old('role') ? 'selected' : '' }}>Humas (Edit Konten, No Delete/Settings)</option>
                    <option value="lpk"            {{ old('role') == 'lpk' ? 'selected' : '' }}>LPK (Laporan Keuangan Sahaja)</option>
                    <option value="bendahara"      {{ old('role') == 'bendahara' ? 'selected' : '' }}>💰 Bendahara (Konfirmasi Iuran Bulanan)</option>
                    <option value="operator_gudep" {{ old('role') == 'operator_gudep' ? 'selected' : '' }}>🏫 Operator Gudep (Kelola Data Gudep Pangkalan)</option>
                    <option value="dkr"            {{ old('role') == 'dkr' ? 'selected' : '' }}>🚩 Operator DKR (Kelola Landing Page DKR)</option>
                </select>
            ...
            <div id="bendaharaRoleInfo" class="alert alert-success d-flex gap-2 align-items-start mb-4 d-none">
            ...
            <div id="permissionsSection" class="mb-4 {{ in_array(old('role'), ['admin', 'operator_gudep']) ? 'd-none' : '' }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="posts" id="perm_posts" {{ in_array('posts', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_posts">Kelola Berita & Materi Pokok</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="sliders" id="perm_sliders" {{ in_array('sliders', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_sliders">Kelola Slider Beranda</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="events" id="perm_events" {{ in_array('events', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_events">Kelola Agenda Kegiatan</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="gallery" id="perm_gallery" {{ in_array('gallery', old('permissions', [])) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="sisran" id="perm_sisran" {{ in_array('sisran', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_sisran">Desain & Rekap Data SISRAN</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="finances" id="perm_finances" {{ in_array('finances', old('permissions', [])) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="messages" id="perm_messages" {{ in_array('messages', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_messages">Lihat Inbox Pesan</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="visitors" id="perm_visitors" {{ in_array('visitors', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_visitors">Lihat Statistik Pengunjung</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="organization" id="perm_organization" {{ in_array('organization', old('permissions', [])) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="downloads" id="perm_downloads" {{ in_array('downloads', old('permissions', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="perm_downloads">Kelola Download Area</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="documents" id="perm_documents" {{ in_array('documents', old('permissions', [])) ? 'checked' : '' }}>
                        ...
                        <div class="alert alert-warning py-2 d-flex align-items-center gap-2 mt-2">
                            ...
                            <div>
                                ...
                                <div class="form-check mt-1">
                                    <input class="form-check-input" type="checkbox" name="permissions[]" value="gudep" id="perm_gudep" {{ in_array('gudep', old('permissions', [])) ? 'checked' : '' }}>
