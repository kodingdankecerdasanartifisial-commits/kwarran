            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="20">{{ old('content', $page->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        @if($page->featured_image)
                            <div class="mb-2"><img src="{{ asset('storage/' . $page->featured_image) }}" class="img-thumbnail" style="max-height: 100px;"></div>
                        @endif
