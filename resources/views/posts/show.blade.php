                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div id="post-content-container">
                        @if($post->is_html)
                            ...
                            <div class="post-iframe-wrapper" style="position: relative; width: 100%; min-height: 1200px; background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.08); border: 1px solid #eee;">
                                <iframe 
                                    id="post-html-iframe" 
                                    style="width: 100%; border: none; overflow: hidden; display: block; height: 1200px; transition: height 0.3s ease-out;" 
                                    scrolling="no"
                                    allowfullscreen
                                ></iframe>
                            </div>
                            ...
                            <script>
                                ...
                                window.addEventListener('message', function(event) {
                                    if (event.data.type === 'resize-html' && event.data.height) {
                                        const iframe = document.getElementById('post-html-iframe');
                                        if (iframe) {
                                            // Respect 1200px minimum or expand if content is larger
                                            const finalHeight = Math.max(event.data.height + 50, 1200);
